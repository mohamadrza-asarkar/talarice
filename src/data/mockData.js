...
export const initialProducts = [
  {
    id: 'prod-1',
    _id: 'prod-1',
    name: 'برنج کامفیروزی ممتاز اعلا طلا رایس - کیسه ۱۰ کیلویی',
  ...
  },
  {
    id: 'prod-2',
    _id: 'prod-2',
    name: 'برنج کامفیروزی کشت اول فوق معطر - کیسه ۱۰ کیلویی',
  ...
  },
  {
    id: 'prod-3',
    _id: 'prod-3',
    name: 'برنج کامفیروزی دودی هیزمی سنتی - کیسه ۵ کیلویی',
  ...
  },
  {
    id: 'prod-4',
    _id: 'prod-4',
    name: 'برنج قهوه‌ای کامفیروزی رژیمی و سبوس‌دار - کیسه ۵ کیلویی',
  ...
  },
  {
    id: 'prod-5',
    _id: 'prod-5',
    name: 'برنج سرلاشه معطر کامفیروزی اعلا - کیسه ۱۰ کیلویی',
  ...
  },
  {
    id: 'prod-6',
    _id: 'prod-6',
    name: 'برنج کامفیروزی مجلسی بوجار دو الک - کیسه ۲۰ کیلویی',
    description: 'کیسه ۲۰ کیلویی مخصوص مهمانی‌ها، مجالس و تالارها؛ یکدستی بی‌نقص، بدون کوچک‌ترین خرده و با ری‌کشی خیره‌کننده.',
    price: 2980000,
    oldPrice: 3300000,
    discountPercent: 10,
    weight: 20,
